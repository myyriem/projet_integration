...
import GoldenCage.gui.fr_acceuil;
...
//    rawJsonResponse();
  ...
  public void fetchObject() {
    ...
    Page page = facebookClient.fetchObject("cocacola", Page.class);
      ...
      ComptesDAO adminDao= new  ComptesDAO() ;
    Comptes administrateur= new Comptes();
    List<Comptes> l=adminDao.afficherComptes();
    for(int i=0;i<l.size();i++)
       {
           if(l.get(i).getEmail().equals(user.getEmail())){
               fr_acceuil adminMenu=new fr_acceuil(l.get(i).getIdCompte());
