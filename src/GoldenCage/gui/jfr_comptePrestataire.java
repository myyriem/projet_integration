 ...
 * @author FGH
 */
public class jfr_comptePrestataire extends javax.swing.JFrame {

    /**
     * Creates new form jfr_comptePrestataire
     */
    ...
    public static void main(String args[]) {
       ...
       try {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jfr_comptePrestataire().setVisible(true);
            }
        });
    }
