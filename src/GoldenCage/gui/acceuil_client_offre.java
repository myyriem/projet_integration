 ...
 * @author FGH
 */
public class acceuil_client_offre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("commentair");

        jLabel2.setText("evaluer");
    ...
    private void bt_acceuilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_acceuilActionPerformed
        acceuil_client_offre stadhere= new acceuil_client_offre();
        stadhere.setVisible(true);
        this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        acceuil_client_service retour_service= new acceuil_client_service();
        retour_service.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(acceuil_client_offre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new acceuil_client_offre().setVisible(true);
            }
        });
    }
